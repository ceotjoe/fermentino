...
<ul>
	...
	<li><a href="#profile-control"><span>Leaven profile</span></a></li>
	<li><a href="#beer-constant-control"><span>Box constant</span></a></li>
...
<div id="temp-control-off">
	<span id="temp-off-text">Temperature control disabled. Box will not heat, but is still logging temperatures.</span>
</div>